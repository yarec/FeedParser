//
//  TestNewsFeedParserDelegate.swift
//  FeedParser
//
...
class TestAtomFeedParserDelegate: NSObject, FeedParserDelegate  {
    ...
    func didFinishFeedParsing(parser:FeedParser, newsFeed:NewsFeed?) {
        ...
        XCTAssertEqual(self.newsFeed.feedType, FeedType.ATOM, "ATOM found.")
        XCTAssertEqual(self.newsFeed.link, "http://example.org/", "Link found")
        XCTAssertEqual(self.newsFeed.entries.count, 1, "1 Entry found")
    }
